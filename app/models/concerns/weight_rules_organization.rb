...
module WeightRulesOrganization
  ...
  WEIGHT_RULES = [
    ...
    { model_key: 'tax_detail', name: 'kagb_classification', relative_weight: 5 },    
    { model_key: 'tax_detail', name: 'transparency_register', relative_weight: 1 },
    ...
    { model_key: 'tax_detail', name: 'wphg_classification', relative_weight: 5 },
